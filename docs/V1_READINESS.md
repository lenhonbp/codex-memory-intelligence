...
| Cross-platform hosted verification | Ready for audited scope | PR #34 workflow runs `31271425009` and `31271493046` passed across Ubuntu/macOS/Windows × Node 22/24; release metadata jobs `93137961793` and `93138128983`; CodeQL analyze runs `31271425018` / `93137961763` and `31271493032` / `93138128712`, with checks `93138062859` and `93138237349`, passed | Preserve this gate on subsequent code changes |
